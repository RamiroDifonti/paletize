...
export const satValue1 = document.querySelector("#s-1-value");
...
export const complementaryValue = document.querySelector("#complementary-value");
export const squareValue = document.querySelector("#square-value");
