...
export const analogousSlider = document.getElementById("analogous")! as HTMLInputElement;
export const splitSlider = document.getElementById("split")! as HTMLInputElement;
export const squareSlider = document.getElementById("square")! as HTMLInputElement;
